#import credentials for mysql-connector object, validates, returns dictionary containing hostname, username, password
...
def importDbCredentials(filePath):
    import yaml
    ...
    #test connection:
    try:
        mysql.connector.connect(user=loginInfo['username']
